...
<a name="createEmbeddingMatcher" href="#createEmbeddingMatcher">#</a> **createEmbeddingMatcher** [\<>](src/index.js#L51-L51)
...
<a name="createJSONResponse" href="#createJSONResponse">#</a> **createJSONResponse** [\<>](src/index.js#L51-L51)
...
<a name="createURLMatcher" href="#createURLMatcher">#</a> **createURLMatcher** [\<>](src/index.js#L51-L51)
...
<a name="getEditedPostContent" href="#getEditedPostContent">#</a> **getEditedPostContent** [\<>](src/index.js#L21-L21)
...
<a name="hasBlockSwitcher" href="#hasBlockSwitcher">#</a> **hasBlockSwitcher** [\<>](src/index.js#L22-L22)
...
<a name="insertBlock" href="#insertBlock">#</a> **insertBlock** [\<>](src/index.js#L23-L23)
...
<a name="installPlugin" href="#installPlugin">#</a> **installPlugin** [\<>](src/index.js#L24-L24)
...
<a name="isCurrentURL" href="#isCurrentURL">#</a> **isCurrentURL** [\<>](src/index.js#L25-L25)
...
<a name="isInDefaultBlock" href="#isInDefaultBlock">#</a> **isInDefaultBlock** [\<>](src/index.js#L26-L26)
...
<a name="loginUser" href="#loginUser">#</a> **loginUser** [\<>](src/index.js#L27-L27)
...
<a name="mockOrTransform" href="#mockOrTransform">#</a> **mockOrTransform** [\<>](src/index.js#L51-L51)
...
<a name="observeFocusLoss" href="#observeFocusLoss">#</a> **observeFocusLoss** [\<>](src/index.js#L28-L28)
...
<a name="openAllBlockInserterCategories" href="#openAllBlockInserterCategories">#</a> **openAllBlockInserterCategories** [\<>](src/index.js#L29-L29)

Opens all block inserter categories.

<a name="openDocumentSettingsSidebar" href="#openDocumentSettingsSidebar">#</a> **openDocumentSettingsSidebar** [\<>](src/index.js#L30-L30)

Clicks on the button in the header which opens Document Settings sidebar when it is closed.

<a name="openGlobalBlockInserter" href="#openGlobalBlockInserter">#</a> **openGlobalBlockInserter** [\<>](src/index.js#L31-L31)

Opens the global block inserter.

<a name="openPublishPanel" href="#openPublishPanel">#</a> **openPublishPanel** [\<>](src/index.js#L32-L32)

Opens the publish panel.

<a name="pressKeyTimes" href="#pressKeyTimes">#</a> **pressKeyTimes** [\<>](src/index.js#L33-L33)
...
<a name="pressKeyWithModifier" href="#pressKeyWithModifier">#</a> **pressKeyWithModifier** [\<>](src/index.js#L34-L34)
...
<a name="publishPost" href="#publishPost">#</a> **publishPost** [\<>](src/index.js#L35-L35)
...
<a name="publishPostWithPrePublishChecksDisabled" href="#publishPostWithPrePublishChecksDisabled">#</a> **publishPostWithPrePublishChecksDisabled** [\<>](src/index.js#L36-L36)
...
<a name="saveDraft" href="#saveDraft">#</a> **saveDraft** [\<>](src/index.js#L37-L37)
...
<a name="searchForBlock" href="#searchForBlock">#</a> **searchForBlock** [\<>](src/index.js#L38-L38)
...
<a name="selectBlockByClientId" href="#selectBlockByClientId">#</a> **selectBlockByClientId** [\<>](src/index.js#L39-L39)
...
<a name="setBrowserViewport" href="#setBrowserViewport">#</a> **setBrowserViewport** [\<>](src/index.js#L40-L40)
...
<a name="setPostContent" href="#setPostContent">#</a> **setPostContent** [\<>](src/index.js#L41-L41)
...
<a name="setUpResponseMocking" href="#setUpResponseMocking">#</a> **setUpResponseMocking** [\<>](src/index.js#L51-L51)
...
<a name="switchEditorModeTo" href="#switchEditorModeTo">#</a> **switchEditorModeTo** [\<>](src/index.js#L42-L42)
...
<a name="switchUserToAdmin" href="#switchUserToAdmin">#</a> **switchUserToAdmin** [\<>](src/index.js#L43-L43)

Switches the current user to the admin user (if the user
running the test is not already the admin user).

<a name="switchUserToTest" href="#switchUserToTest">#</a> **switchUserToTest** [\<>](src/index.js#L44-L44)

Switches the current user to whichever user we should be
running the tests as (if we're not already that user).

<a name="toggleScreenOption" href="#toggleScreenOption">#</a> **toggleScreenOption** [\<>](src/index.js#L45-L45)
...
<a name="transformBlockTo" href="#transformBlockTo">#</a> **transformBlockTo** [\<>](src/index.js#L46-L46)
...
<a name="uninstallPlugin" href="#uninstallPlugin">#</a> **uninstallPlugin** [\<>](src/index.js#L47-L47)
...
<a name="visitAdminPage" href="#visitAdminPage">#</a> **visitAdminPage** [\<>](src/index.js#L48-L48)
...
<a name="waitForWindowDimensions" href="#waitForWindowDimensions">#</a> **waitForWindowDimensions** [\<>](src/index.js#L49-L49)
